        ...
        <div class="container">
            <div class="footer__bottom">
                <div class="footer__copyright">
                    <p>© {!! date('Y') !!}, YetiCave</p>
                    <p>Online auction for snowboard and ski equipment</p>
                </div>

                <div class="footer__social social">
                    <span class="visually-hidden">Follow us on social media:</span>
                    ...
                    <a class="social__link social__link--twitter" href="https://x.com/">X
                    ...
                    <a class="social__link social__link--instagram" href="https://instagram.com/">Instagram
                ...
                <div class="footer__logo">
                    <a class="footer__link" href="{{ route('home') }}">
                        <img src="{{ asset('img/logo.svg') }}" width="160" height="39" alt="YetiCave company logo">
                    </a>
                </div>
            </div>
